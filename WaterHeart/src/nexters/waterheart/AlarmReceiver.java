...
public class AlarmReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		if ("android.intent.action.BOOT_COMPLETED".equals(intent.getAction())) {
			...
			/*
			MainActivity main = MainActivity.getThisFuckinActivity();
			if(main == null){
				Intent intent03 = new Intent(context, MainActivity.class);
				intent03.setFlags(Intent.FLAG_FROM_BACKGROUND|Intent.FLAG_ACTIVITY_NEW_TASK);
