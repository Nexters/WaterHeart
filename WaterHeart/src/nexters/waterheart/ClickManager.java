...
public class ClickManager implements View.OnClickListener {
			...
			if (MainFragment.yourName.equals("")) {
				...
				case R.id.main_cup_drop:
					...
					if (water == MainFragment.totalWater)
						msg = Message.obtain(mHandler, 7, water, 0);
					else
	...
	public void historySwap(int resId) {
		...
		case R.id.history_heart_06:
			if (mActivity.findViewById(R.id.resultspage_change_6_01)
					.getVisibility() == View.VISIBLE) {
				mActivity.findViewById(R.id.resultspage_change_6_02)
						.setVisibility(View.VISIBLE);
				mActivity.findViewById(R.id.resultspage_change_6_01)
						.setVisibility(View.GONE);
			} else {
				mActivity.findViewById(R.id.resultspage_change_6_02)
						.setVisibility(View.GONE);
		...
		case R.id.history_heart_05:
			if (mActivity.findViewById(R.id.resultspage_change_5_01)
					.getVisibility() == View.VISIBLE) {
				mActivity.findViewById(R.id.resultspage_change_5_02)
						.setVisibility(View.VISIBLE);
				mActivity.findViewById(R.id.resultspage_change_5_01)
						.setVisibility(View.GONE);
			} else {
				mActivity.findViewById(R.id.resultspage_change_5_02)
						.setVisibility(View.GONE);
		...
		case R.id.history_heart_04:
			if (mActivity.findViewById(R.id.resultspage_change_4_01)
					.getVisibility() == View.VISIBLE) {
				mActivity.findViewById(R.id.resultspage_change_4_02)
						.setVisibility(View.VISIBLE);
				mActivity.findViewById(R.id.resultspage_change_4_01)
						.setVisibility(View.GONE);
			} else {
				mActivity.findViewById(R.id.resultspage_change_4_02)
						.setVisibility(View.GONE);
		...
		case R.id.history_heart_03:
			if (mActivity.findViewById(R.id.resultspage_change_3_01)
					.getVisibility() == View.VISIBLE) {
				mActivity.findViewById(R.id.resultspage_change_3_02)
						.setVisibility(View.VISIBLE);
				mActivity.findViewById(R.id.resultspage_change_3_01)
						.setVisibility(View.GONE);
			} else {
				mActivity.findViewById(R.id.resultspage_change_3_02)
						.setVisibility(View.GONE);
		...
		case R.id.history_heart_02:
			if (mActivity.findViewById(R.id.resultspage_change_2_01)
					.getVisibility() == View.VISIBLE) {
				mActivity.findViewById(R.id.resultspage_change_2_02)
						.setVisibility(View.VISIBLE);
				mActivity.findViewById(R.id.resultspage_change_2_01)
						.setVisibility(View.GONE);
			} else {
				mActivity.findViewById(R.id.resultspage_change_2_02)
						.setVisibility(View.GONE);
		...
		case R.id.history_heart_01:
			if (mActivity.findViewById(R.id.resultspage_change_1_01)
					.getVisibility() == View.VISIBLE) {
				mActivity.findViewById(R.id.resultspage_change_1_02)
						.setVisibility(View.VISIBLE);
				mActivity.findViewById(R.id.resultspage_change_1_01)
						.setVisibility(View.GONE);
			} else {
				mActivity.findViewById(R.id.resultspage_change_1_02)
						.setVisibility(View.GONE);
